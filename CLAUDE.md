This code is develop in TDD mode. The programmer will ask a feature, claude will internally discuss with 3 agents plans and present 3 plans. The plans should be presented with diagrams when text is too long (probably sequence diagram, activity diagram, component diagram or even ER diagram)
